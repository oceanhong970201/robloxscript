...
local Window = Library.CreateLib("Base Battles", "BloodTheme")
local Tab1 = Window:NewTab("Main")
local Tab2 = Window:NewTab("Others")
local Section = Tab1:NewSection("Main")
local Section2 = Tab2:NewSection("Other")

Section:NewButton("Slient Aim", "Slient Aim", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/oceanhong970201/robloxscript/main/Base%20Battles%20Slient%20Aim.lua"))()
end)

Section:NewButton("Kill All(UNSTOPPABLE)", "Kill All", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/oceanhong970201/robloxscript/main/Base%20Battles%20Kill%20All.lua"))()
end)
--\\ Other Stuff//--
