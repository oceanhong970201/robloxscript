...
Section:NewButton("Tp to safe place", "Tp to safe place", function()
    ...
    BuildPart.Position = Vector3.new(196, 103, 73)      --The Position of The Part
    BuildPart.Anchored = true                             --Anchores The Part
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(196, 113, 73)
end)
