...
bg = pygame.image.load(
    '/Users/Win10/Downloads/Flappy-Bird-main/Flappy-Bird-main/Images/bg.png')
# loading ground image
ground_img = pygame.image.load(
    '/Users/Win10/Downloads/Flappy-Bird-main/Flappy-Bird-main/Images/ground.png')
# loading button image
button_img = pygame.image.load(
    '/Users/Win10/Downloads/Flappy-Bird-main/Flappy-Bird-main/Images/restart.png')
...
class Bird(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        for i in range(1, 4):
            img = pygame.image.load(
                '/Users/Win10/Downloads/Flappy-Bird-main/Flappy-Bird-main/Images/bird{}.png'.format(i))
    ...
    # adding game physics
        ...
        self.image = pygame.transform.rotate(
            self.images[self.img_index], -2*self.vel)
...
class Pipe(pygame.sprite.Sprite):
    def __init__(self, x, y, position):
        ...
        self.image = pygame.image.load(
            '/Users/Win10/Downloads/Flappy-Bird-main/Flappy-Bird-main/Images/pipe.png')
        self.rect = self.image.get_rect()
        if position == 1:
            self.rect.topleft = [x, y]
        if position == -1:
...
while (run):
    ...
    if ((bird_alive) and (fly)):
        ...
        if (abs(time_now - time_last_pipe) > pipe_freq):
            ...
            bottom_pipe = Pipe(
                screen_width, ((screen_height // 2) + (pipe_gap / 2) + pipe_height), 1)
            top_pipe = Pipe(
                screen_width, ((screen_height // 2) - (pipe_gap / 2) + pipe_height), -1)
    ...
    if len(pipe_group):
        ...
        if (((bird_group.sprites()[0].rect.left) > (pipe_group.sprites()[0].rect.right)) and (bird_in_between == True)):
            counter += 1
            bird_in_between = False
    text2img(('SCORE: ' + str(counter)), font_type1,
             red, (screen_width/2 - 60), 25)
